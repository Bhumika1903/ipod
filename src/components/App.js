...
// Import songs
import song1 from "../static/songs/Call Aundi Video Song  ZORAWAR  Yo Yo Honey Singh  T-Series.mp3"
import song2 from "../static/songs/CKay - Love Nwantiti (Lyrics).mp3"
import song3 from "../static/songs/Safar.mp3"
import song4 from "../static/songs/Tere Te (Official Video)  AP Dhillon  Gurinder Gill  Latest Punjabi Song 2022  Hidden Gems.mp3"
import song5 from "../static/songs/We Rollin (Official Audio) - Shubh.mp3"
...
class App extends React.Component {
  constructor() {
    ...
    this.state = {
      ...
      songItems: ["Call Aundi", "Love Nwantiti", "Safar","Tere Te","We Rollin"], //song names
